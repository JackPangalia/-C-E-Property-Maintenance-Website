  ...
  return (
    <section className="relative h-[85vh] overflow-hidden ">
      ...
      <div className="absolute inset-0 bg-black/60 flex items-start justify-center flex-col">
        ...
        <Link href = '#' className = 'lg:ml-[15rem] md:ml-[8rem] ml-[1rem] text-white border-[1px] lg:px-10 lg:py-2 md:px-8 md:py-1 py-1 px-4 mt-4 md:text-lg hover:bg-black hover:bg-opacity-30 transition-all duration-300'>Get a quote</Link>
      </div>
    </section>
  );
}
